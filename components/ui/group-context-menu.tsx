...
import { LogOut, BellOff, UserPlus, Settings } from "lucide-react"
...
interface GroupContextMenuProps {
  ...
  y: number
  onClose: () => void
  onInvitePeople?: (groupId: string) => void
  onMute?: (groupId: string, hours: number) => void
